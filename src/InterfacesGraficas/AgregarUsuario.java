...
public class AgregarUsuario extends javax.swing.JFrame {
    ...
    private void AgregarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarUsuarioActionPerformed
        ...
        String infoGrafo = f.leertxt("Build\\classes\\Files\\usuarios.csv");
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            ...
            String[] usuario = jTextField1.getText().split("csv");
        ...
        if (!usuario[1].isEmpty()) {
            String usuarioTxt = usuario[1] + "," + respuesta + "\n";
            usuarios.add(usuarioTxt);

            // Escribir todos los usuarios en el archivo
            try (BufferedWriter bw = new BufferedWriter(new FileWriter(file))) {
                for (String usuarioActual : usuarios) {
                    bw.write(usuarioActual);
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
